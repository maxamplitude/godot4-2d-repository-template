...
func set_setting(section: String, key: String, value: Variant, save_immediately: bool = true) -> void:
	...
	GameServices.events.settings_changed.emit(section, key, value)
...
func apply_audio_settings() -> void:
	...
	GameServices.audio.set_bus_volume("Master", master_volume)
	GameServices.audio.set_bus_volume("Music", music_volume)
	GameServices.audio.set_bus_volume("SFX", sfx_volume)
	GameServices.audio.set_bus_volume("UI", ui_volume)
